...
//                     dishEl.innerHTML = `<div class="img-container">
//            <img src="${dish.img}"
//            alt = "${dish.name}"/>
//             </div>
//            <div class="info">
...
//              </div>
//              <div>
//              <small class="type"><span>Price: $${dish.price}</span></small>
//             </div>
//              <ul>
//              <small class="stats">Ingredients:<b> ${dish.description}<b></small>
//             </ul>`;
